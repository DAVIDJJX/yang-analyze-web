...
(function () {
  ...
  var COLUMNS = [
    { key: "dateStart", h: "日期(起)", level: "station", type: "date", required: true, width: 12.0, bodyStyle: S.DATE2, edit: "date" },
    { key: "timeStart", h: "時間(起)", level: "station", type: "time", required: true, bodyStyle: S.TIME2, edit: "time" },
    { key: "dateEnd", h: "日期(迄)", level: "station", type: "date", required: true, bodyStyle: S.DATE2, edit: "date" },
    { key: "timeEnd", h: "時間(迄)", level: "station", type: "time", required: true, manual: true, bodyStyle: S.TIME2, edit: "time" },
    { key: "site", h: "採樣地點", level: "station", type: "text", required: true, width: 13.1, bodyStyle: S.TIME2, edit: "text" },
    { key: "coordSys", h: "座標系統", level: "station", type: "number", required: true, manual: true, width: 15.1, bodyStyle: S.BODY2, edit: "coordsys" },
    { key: "x", h: "採樣座標-經度 X", level: "station", type: "number", required: true, manual: true, width: 23.2, bodyStyle: S.BODY2, edit: "number" },
    { key: "y", h: "採樣座標-緯度 Y", level: "station", type: "number", required: true, manual: true, width: 23.1, bodyStyle: S.BODY2, edit: "number" },
    ...
    { key: "category", h: "檢測類別", level: "station", type: "text", required: true, width: 13.1, bodyStyle: S.BODY2, edit: "category" },
    { key: "itemName", h: "檢測項目", level: "item", type: "text", required: true, bodyStyle: S.BODY2, edit: "text" },
    { key: "unitCode", h: "檢測濃度/質量單位", level: "item", type: "number", required: true, width: 26.8, bodyStyle: S.BODY2, edit: "number" },
    ...
    { key: "valueOut", h: "檢測數值", level: "item", type: "auto", required: true, bodyStyle: S.BODY2, edit: "text" },
    { key: "mdl", h: "檢測極限", level: "item", type: "auto", bodyStyle: S.BODY2, edit: "text" },
    { key: "methodOut", h: "檢測方法", level: "item", type: "text", required: true, bodyStyle: S.BODY2, edit: "text" },
    { key: "license", h: "檢測機構許可證號", level: "station", type: "number", required: true, width: 25.4, bodyStyle: S.BODY2, edit: "text" },
